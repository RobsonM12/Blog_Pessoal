...
public class UsuarioControllerTest {
	...
	@Test
	@Order(5)
	@DisplayName("Consultar um Usuário especifico")
	public void deveListarUmUsuarios() {

		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "Bruno Santos",
				"Bruno_Santos@email.com.br", "bruno123", "https://i.imgur.com/Sk5SjWE.jpg"));
	...
	/* faltando ajeitar a requisição apenas.
	@Test
	@Order(6)
	@DisplayName("Login com um Usuário")
	public void deveAutenticarUsuarios() {
		
		usuarioService.cadastrarUsuario(new Usuario(0L, "Sonia Dias", "sonia_dias@email.com.br", "sonia123",
				"https://i.imgur.com/5M2p5Wb.jpg"));
		
		HttpEntity<UsuarioLogin> corpoResposta = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, 
			"",	"sonia_dias@email.com.br", "13465278", "", ""));

		ResponseEntity<UsuarioLogin> resposta = testRestTemplate
				.exchange("/usuarios/logar", HttpMethod.POST, requisicao,
				UsuarioLogin.class);
